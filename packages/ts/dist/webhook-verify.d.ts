export declare const FIKASHOP_SIGNATURE_HEADER = "X-Fikachu-Signature";
export declare const FIKASHOP_UNIFIED_SIGNATURE_HEADER = "Fikashop-Signature";
export declare function computeFikashopSignature(secret: string, rawBody: Buffer | Uint8Array | string): string;
...
export declare function verifyFikashopSignature(secret: string, rawBody: Buffer | Uint8Array | string, providedSig: string): boolean;
