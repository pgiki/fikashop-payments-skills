...
export function parseUnifiedWebhookEnvelope(payload: unknown): import('./types.js').UnifiedWebhookEnvelope | null {
...
export function extractWebhookInvoiceReference(envelope: import('./types.js').UnifiedWebhookEnvelope): string {
